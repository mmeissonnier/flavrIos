...
var Button = function Button(_ref) {
  ...
  return React__default.createElement(ButtonContainer, {
    style: style
  }, React__default.createElement(Svg__default, {
    width: "100%",
    height: "100%",
    style: {
      position: 'absolute',
  ...
  }, React__default.createElement(Svg.Defs, null, React__default.createElement(Svg.LinearGradient, {
    x1: "5.67655342%",
    y1: "50.8049907%",
    x2: "103.849473%",
    y2: "48.6205593%",
  ...
  function (_PureComponent) {
    ...
    _createClass(IconButton, [{
      ...
      value: function render() {
        ...
        return React__default.createElement(reactNative.TouchableHighlight, _extends({
          style: [styles.touchable, blockStyle]
        }, touchableProps), React__default.createElement(reactNative.View, _extends({
          style: [styles.container, blockStyle, style]
        }, props), React__default.createElement(Icon, iconProps), isString_1(children) ? React__default.createElement(reactNative.Text, {
...
function createTabBarItemIOSComponent(IconNamePropType, getImageSource) {
  ...
  function (_PureComponent) {
    ...
    _createClass(TabBarItemIOS, [{
      ...
      key: "render",
      value: function render() {
        return React__default.createElement(reactNative.TabBarIOS.Item, _extends({}, this.state, this.props));
      }
    }]);
...
function createToolbarAndroidComponent(IconNamePropType, getImageSource) {
  ...
  function (_PureComponent) {
    ...
    _createClass(IconToolbarAndroid, [{
      ...
      key: "render",
      value: function render() {
        return React__default.createElement(reactNative.ToolbarAndroid, _extends({}, this.props, this.state));
      }
    }]);
...
var NativeIconAPI$1 = reactNative.NativeModules.RNVectorIconsManager || reactNative.NativeModules.RNVectorIconsModule;
var DEFAULT_ICON_SIZE = 12;
var DEFAULT_ICON_COLOR = 'black';
function createIconSet(glyphMap, fontFamily, fontFile, fontStyle) {
  // Android doesn't care about actual fontFamily name, it will only look in fonts folder.
  var fontBasename = fontFile ? fontFile.replace(/\.(otf|ttf)$/, '') : fontFamily;
  var fontReference = reactNative.Platform.select({
  ...
  function (_PureComponent) {
    ...
    _createClass(Icon, [{
      ...
      value: function render() {
        ...
        return React__default.createElement(reactNative.Text, props, glyph, children);
      }
    }]);
  ...
  function getImageSource(name) {
    ...
    var processedColor = reactNative.processColor(color);
    var cacheKey = "".concat(glyph, ":").concat(size, ":").concat(processedColor);
    var scale = reactNative.PixelRatio.get();
    return new Promise(function (resolve, reject) {
...
var LabelIcon = function LabelIcon(_ref2) {
  ...
  return React__default.createElement(Row, {
    m: margin
  }, React__default.createElement(iconSet, {
    size: iconSize || size,
    name: icon,
    color: color
...
var RecipeCard = function RecipeCard(_ref) {
  ...
  return React__default.createElement(Wrapper, {
    ...
    resizeMode: "cover"
  }), React__default.createElement(InfoWrapper, null, React__default.createElement(Label, {
    color: "#9E9E9E",
    font: "Montserrat",
    size: 13,
    transform: "uppercase",
    margin: "10px 0 6px 0"
  }, category), React__default.createElement(Label, {
    color: "#333333",
    font: "Montserrat-Medium",
    size: 20,
    transform: "uppercase",
    margin: "0 0 12px 0"
  }, title), React__default.createElement(Row$1, null, infos.map(function (info) {
    return React__default.createElement(LabelIcon, {
      key: info.icon,
      icon: info.icon,
